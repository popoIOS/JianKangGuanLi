...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item <firstCorner || indexPath.item>lastConter) {
        ...
        if ([[self.useTime timeChineseDaysWithDate:dateStr] isEqualToString:@"初一"]) {
            cell.lunarDay = [self.useTime timeChineseCalendarMothWithString:dateStr];
        }else{
...
//        cell.gregoiainCalendar = [self holidaysOfYearWithData:indexPath chineseMoth:[self.useTime timeChineseCalendarMothWithString:dateStr] DataStr:dateStr];
...
-(NSString *)holidaysOfYearWithData:(NSIndexPath *)indexPath chineseMoth:(NSString *)chineseMoth DataStr:(NSString *)dataStr{
